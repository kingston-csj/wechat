...
public class MessageContentFactory implements LifeCycle {
    ...
    @Override
    public void init() {
        mapper.put(MessageContentType.TYPE_TEXT, TextMessageContent.class);
        mapper.put(MessageContentType.TYPE_IMAGE, ImageMessageContent.class);
        mapper.put(MessageContentType.TYPE_FILE, FileMessageContent.class);
